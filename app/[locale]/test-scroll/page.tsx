...
import { FadeInOnScrollSafe } from "@/components/ui/FadeInOnScrollSafe";
...
export default async function TestScrollPage({
  ...
  return (
    <main className="min-h-dvh">
      ...
      {/* Zone test — FadeInOnScrollSafe (opacity seule, AUCUN transform)
          enveloppe FeaturedDesktopTest (pin sticky du commit f4418e2). */}
      <FadeInOnScrollSafe>
        <FeaturedDesktopTest
          items={featured}
