// /journal — alias éditorial premium de /blog (brief V3 CHANTIER 6).
// Le contenu et la table Supabase restent sous "blog_posts" ; seule la
// surface publique est renommée "Journal" pour un ton AD Magazine.
